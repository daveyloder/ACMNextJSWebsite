...
export interface ApiClubClub extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    Name: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    President: Schema.Attribute.String & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiEventEvent extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    Description: Schema.Attribute.Blocks & Schema.Attribute.Required;
    eventType: Schema.Attribute.Enumeration<['Meeting', 'Social', 'Workshop']>;
    eventUrl: Schema.Attribute.String & Schema.Attribute.DefaultTo<'/'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiMemberRosterMemberRoster extends Struct.SingleTypeSchema {
  collectionName: 'member_rosters';
  info: {
    displayName: 'MemberRoster';
    pluralName: 'member-rosters';
    singularName: 'member-roster';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::member-roster.member-roster'
    > &
      Schema.Attribute.Private;
    MemberJson: Schema.Attribute.JSON;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::member-roster.member-roster': ApiMemberRosterMemberRoster;
